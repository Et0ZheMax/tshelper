...
OMG_OU_TREE = {
    "outsource": [],
    "лаборатория когнитивных технологий": [],
    ...
    "управление информационных систем": [
        ...
        "отдел методологии и сопровождения информационных систем",
        "отдел развития базы доноров",
        "отдел функциональной аналитики",
    ],
    "управление информационных технологий": [
        "отдел информационно-сервисного сопровождения",
    ...
    "управление организации и проведения исследований": [
        ...
        "отдел биоинформатики и системного анализа",
        "отдел вычислительной биологии",
        "отдел медицинской геномики",
        "отдел организации проведения клинических исследований",
        "отдел психофармакологии",
        "отдел эпигенетических методов исследований",
    ],
    "управление экспериментальной биотехнологии и генной инженерии": [
        ...
        "отделение биобанк генетических ресурсов",
        "отделение производства рекомбинантных белков",
    ],
}

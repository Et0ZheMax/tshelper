...
- **Встроенные приложения:** ADHelper 2.0.16 на PySide6 и Print Monitor на SNMP/HTTP.
...
- управление группами доступа и контроль соответствия OU организационным атрибутам через ADHelper 2.0.16;

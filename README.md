...
- несколько Windows/Linux-компьютеров в одной карточке, разовый выбор основного ПК при первом открытии и заметное временное переключение целевого хоста для одного действия;

...
- отзывчивый интерфейс: готовый поисковый индекс, дельта-отрисовка результатов, компактные многокомпьютерные карточки, фоновые AD/GLPI Sync и ограниченная ping-очередь;

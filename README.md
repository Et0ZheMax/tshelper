...
- безопасное самообновление portable-версии из GitHub Releases: загрузка в фоне, проверка SHA-256, резервная копия, замена файлов и автоматический перезапуск.

...
Встроенный ADHelper 2.0.16 расположен в `apps/adhelper2`. Он использует PySide6, отдельные сервисы AD/PowerShell и аудит операций; модуль управления доступами работает с группами и ACL, а OU-контроль сопоставляет организационные атрибуты с фактическим деревом каталога.
